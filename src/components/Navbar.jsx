      ...
      <div className="container mx-auto px-6">
        <div className="flex justify-between items-center h-20">
            ...
            {isAuthenticated ? (
              <div className="flex items-center gap-4 ml-6 pl-6 border-l border-white/10">
                ...
                {isAdmin && (
                  <NavLink
                    to="/admin"
                    className="text-[#38E07B] hover:text-white transition-colors p-2 hover:bg-white/5 rounded-full"
                  >
                    <FiGrid className="text-xl" title="Admin Panel" />
                  </NavLink>
                )}
              ...
              <div className="flex items-center gap-4 ml-6">
                <NavLink
                  to="/login"
                  className="text-white hover:text-[#38E07B] font-medium transition-colors"
                >
                  Log In
                </NavLink>
                <NavLink
          ...
          <button
            ...
            className="md:hidden text-white text-2xl focus:outline-none z-50 p-2"
          >
            {isOpen ? <FiX /> : <FiMenu />}
          </button>
        </div>
            ...
            {isAuthenticated && (
              <div className="flex items-center gap-4 mb-8 pb-8 border-b border-white/10">
                <img
                  src={getAvatarSrc(user?.avatar)}
                  alt="Profile"
                  className="w-12 h-12 rounded-full border-2 border-[#38E07B]"
                />
                <div>
                  <p className="text-white font-bold text-lg">{user?.name}</p>
                  <p className="text-gray-400 text-sm">{user?.email}</p>
