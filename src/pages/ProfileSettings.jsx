  ...
  return (
    <div className="max-w-5xl mx-auto pb-12 relative">
      ...
      <div className="mb-6 md:mb-10 relative z-10">
        ...
        <p className="text-gray-400 mt-1 text-sm md:text-base">Manage your personal information and subscription.</p>
      </div>

      {/* Main Card - Responsive Grid (1 col on mobile, 3 on desktop) */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 relative z-10">
        ...
        <div className="space-y-4">
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-4 shadow-lg flex flex-row md:flex-col gap-2 overflow-x-auto">
            ...
            <Link to="/plans" className="flex-shrink-0 flex items-center gap-3 px-4 py-3 text-gray-400 font-medium rounded-xl hover:bg-white/5 hover:text-white transition-all whitespace-nowrap">
               <FiCreditCard /> Subscription
            </Link>
          </div>
        </div>
        ...
        >
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-8 md:space-y-10 relative z-10">
            ...
            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 pb-8 border-b border-white/10">
              ...
              <div className="text-center md:text-left">
                 <h3 className="text-lg md:text-xl font-bold text-white">Profile Picture</h3>
               ...
               <div className="bg-white/5 border border-white/10 rounded-2xl p-4 md:p-6">
                  <div className="flex flex-col md:flex-row justify-between md:items-center gap-4">
                     ...
                     <div>
                        <p className="text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Current Plan</p>
                        <div className="flex items-center gap-2">
                          <span className="text-xl md:text-2xl font-bold text-[#38E07B]">{user?.plan}</span>
                          {user?.plan !== 'Free' && (
                            <span className="px-2 py-0.5 bg-[#38E07B]/20 text-[#38E07B] text-[10px] font-bold rounded-full border border-[#38E07B]/30">
                              PREMIUM
                            </span>
                     ...
                     {/* Logic for Free vs Premium - Stacked buttons on mobile */}
                     {user?.plan === 'Free' ? (
            ...
            {/* Action Bar - Stacked buttons on mobile */}
            <div className="pt-6 flex flex-col-reverse md:flex-row items-center gap-4 border-t border-white/10">
              ...
              <button
                type="submit"
                disabled={updateProfileMutation.isPending}
                className="w-full md:w-auto flex items-center justify-center px-8 py-3 bg-[#38E07B] text-[#122017] font-bold rounded-xl shadow-[0_0_20px_rgba(56,224,123,0.3)] hover:shadow-[0_0_30px_rgba(56,224,123,0.5)] hover:scale-[1.02] transition-all disabled:opacity-70 disabled:cursor-not-allowed"
              >
                {updateProfileMutation.isPending ? (
                   <span className="flex items-center gap-2">
                     <div className="w-4 h-4 border-2 border-[#122017] border-t-transparent rounded-full animate-spin"/> 
